...
public sealed class AuditEventConfiguration : IEntityTypeConfiguration<AuditEvent>
{
    ...
    private static string ActionCode(AuditAction value) => value switch
    {
        ...
        AuditAction.InstallationPushAddressChanged => "installation_push_address_changed",
    ...
    private static AuditAction ActionFromCode(string code) => code switch
    {
        ...
        "installation_push_address_changed" => AuditAction.InstallationPushAddressChanged,
