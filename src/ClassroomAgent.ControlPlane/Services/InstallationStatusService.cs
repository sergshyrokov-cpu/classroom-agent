...
/// change without its audit row or an audit row without its change (db-design §5).
/// </summary>
public class InstallationStatusService(ControlPlaneDbContext db, TimeProvider timeProvider)
{
