...
| **Dean** | Декан, учебная часть | The primary user: views courses, gradebooks and attendance, exports reports, triggers synchronization. |
...
| **ClassroomParticipant** | участник Classroom | A person synced from Classroom — Google user id, email, name. Teachers and students are both this. |
| **Course** | курс | A Google Classroom course: name, section, owner, state, linked groups, calendar id. |
| **Group** | учебная группа | A Google Workspace group with its own email address. Adding the group email to a course roster enrolls all its current and future members. |
...
| **MeetSession** | сессия Meet | A Google Meet attendance record: participant, start, end, duration. The basis of attendance reporting. |
...
| **Attendance** | посещаемость | Presence at video lessons, derived from `MeetSession`. Not self-reported. |
