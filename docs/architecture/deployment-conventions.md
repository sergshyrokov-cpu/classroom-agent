...
4. Owner registers the school as an `Installation`: name, Google Workspace
   ...
   installation id the Control Plane shows on the school's page — step 6 needs
   it (v69).
...
- Per-installation configuration is at minimum: its installation id (the
  `Installation` id generated by the Control Plane, v69), its database connection string,
